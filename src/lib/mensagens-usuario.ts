...
export const MSG = {
  ...
  caixaAberto: 'Caixa aberto com sucesso.',
  caixaFechado: 'Caixa fechado com sucesso.',
  caixaJaAberto: 'Já existe um caixa aberto para esta oficina.',
  erroAbrirCaixa: 'Não foi possível abrir o caixa.',
  erroFecharCaixa: 'Não foi possível fechar o caixa.',
  saldoInicialInvalido: 'Informe um saldo inicial válido.',
  saldoFinalInvalido: 'Informe um saldo final válido.',
  movimentoCaixaRegistrado: 'Movimento registrado com sucesso.',
  movimentoCaixaCancelado: 'Movimento cancelado.',
  erroRegistrarMovimentoCaixa: 'Não foi possível registrar o movimento.',
  erroCancelarMovimentoCaixa: 'Não foi possível cancelar o movimento.',
